<aside id="popup2">
    ...
    <h2>Dodaj pomiar wzrostu</h2>
     
<form action="includes/add_height.inc.php" method="POST">
  <div class="imgcontainer">
    <img src="images/metr.jpg" alt="Avatar" class="avatar">
  </div>

  <div class="container">
    <label><b>Wzrost</b></label>
    <input type="text" placeholder="Dodaj wzrost w cm" name="height" required>
